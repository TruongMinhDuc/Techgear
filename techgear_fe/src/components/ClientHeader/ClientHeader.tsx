...
import { PromotionUpdate } from 'pages/promotion';
        ...
        <Stack spacing={0} ref={refHeaderStack}>
          ...
          <Group position="apart" mb="md">
            <Group spacing={theme.spacing.xs / 2}>
              ...
              <Button variant="subtle" radius="md" leftIcon={<Tag size={16} />}>
                Tặng màn khi Build PC
              </Button>
              {/* <Button variant="subtle" radius="md" leftIcon={<FileBarcode size={16} />}>
                Tin công nghệ
              </Button> */}
              <Button variant="subtle" color="green" radius="md" leftIcon={<Settings size={16} />}>
                Dịch vụ sửa chữa
              </Button>
              <Button variant="subtle" color="cyan" radius="md" leftIcon={<CreditCard size={16} />}>
                Dịch vụ kĩ thuật tại nhà
              </Button>
              <Button variant="subtle" color="yellow" radius="md" leftIcon={<Coin size={16} />}>
                Thu cũ đổi mới
              </Button>
              <Button variant="subtle" color="pink" radius="md" leftIcon={<ShieldCheck size={16} />}>
                Tra cứu bảo hành
              </Button>
            </Group>
            <Group spacing="xs">
